...
INSERT INTO personalData(email_address, first_name, last_name, date_of_birth, location, gender, phone_number, id_photo) VALUES
("danieljames@alx.com", "Daniel", "James", "1989-07-19", "Juja", "Male", "254714790014", id_photo),
("lilianchege@jkuat.ac.ke", "Lilian", "Chege", "1994-02-27", "Kalimoni", "Female", "24711599840", id_photo),
("beatricendinda@amazon.com", "Beatrice", "Ndinda", "2002-11-30", "Theta", "Female", "254707014002", id_photo),
("testing@gmail.com", "Denzel", "Washington", "2000-09-30", "Witeithie", "Male", "254712345678", id_photo),
("alphanice@alx.com", "Alpha", "Shirima", "1999-12-22", "Oasis", "Female", "254799063225", id_photo);
...
("testing2@gmail.com", "Jomo Kenyatta University of Agriculture and Technology", "Certificate", "Information Technology", "2017-04-01", "2022-07-01");
...
("testing2@gmail.com", "Komarock Secondary", "C", "2016-11-01", "2014-04-01");
...
("testing2@gmail.com", "Komarock Primary", "354", "2013-11-01", "2011-04-01");
...
INSERT INTO jujaworks.workExperience(email_address, job_title, company, employment_type, start_date, end_date) VALUES
("alphanice@alx.com", "Electrical Engineer", "General Motors", "Internship","2022-12-01", "Present"),
("beatricendinda@amazon.com", "Auditor", "Ngamia Haulers", "Full time", "2021-09-19", "2022-06-22"),
("danieljames@alx.com", "Lab Technician", "Baringo Girls", "Full time", "2021-01-17", "2023-01-31"),
("lilianchege@jkuat.ac.ke", "Salesperson", "Jumia", "Internship", "2022-09-01", "2022-12-24"),
("testing@gmail.com", "IT Personnel", "Simba Cement", "Part time", "2020-05-24", "2021-09-31"),
("testing2@gmail.com", "IT Support", "Copy Cat", "Full time", "2019-04-01", "Present");
...
("testing2@gmail.com", "Problem-solving, Technical troubleshooting, Customer service, Communication, Ticket management, Active listening, Remote support, Desktop support, Network troubleshooting, Attention to detail");
